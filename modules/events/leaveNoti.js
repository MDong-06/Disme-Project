...
function _0x382e() {
    const _0xea349f = ['.gìf', 'leaveGif', 'floor', '78064RBKQGj', '85tUCdFH', 'customLeave', 'onLoad', '𝙩ự 𝙧ờ𝙞', 'nodemodule', '36ZwKWwf', '𝙗ị 𝙦𝙪ả𝙣 𝙩𝙧ị 𝙫𝙞ê𝙣 đá', '245udigqB', 'config', 'sendMessage', 'HĐGN', '130hnCFLX', 'leftParticipantFbId', '109299XNBCrO', 'author', 'randomgif', '1.0.0', '{name} 𝗕𝗶̣ 𝗛𝗼̂̀𝗻 𝗕𝗮𝘆 𝗣𝗵𝗮́𝗰𝗵 𝗟𝗮̣𝗰 𝗞𝗵𝗼̉𝗶 𝗕𝗼𝘅 𝗗𝗼 𝗡𝗴𝗵𝗶𝗲̣̂𝗽 𝗤𝘂𝗮́ 𝗡𝗮̣̆𝗻𝗴. 𝗖𝗵𝘂́𝗰 𝗕𝗮̣𝗻 {name} 𝗖𝗼̂́ 𝗚𝗮̆́𝗻𝗴 𝗫𝗮̉ 𝗡𝗴𝗵𝗶𝗲̣̂𝗽. 𝗦𝗮𝘆 𝗚𝗼𝗼𝗱𝗕𝘆𝗲 {name} 🍑', 'getCurrentUserID', 'undefined', 'data', '41960JIOJoP', '36ZcDwMy', 'threadData', 'logMessageData', 'log:unsubscribe', 'path', 'getNameUser', 'cache', 'exports', 'replace', 'run', '9111mqPxia', 'random', '248652jAXEzJ', '2846040HCHaek', '2551571QKMSbP', 'length'];
    _0x382e = function () {
        return _0xea349f;
    };
    return _0x382e();
